/*
* Usage: Main B M Input CoordinateToSortBy
* Last test : 21/05/2017
* Arguments : 40000 400000 input-2-21-normal-0.75.csv x
...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        B = 4000; //Integer.parseInt(args[0]);
        M = 40000; //Integer.parseInt(args[1]);
        // m = (int)Math.ceil(M/B);
		...
		for (File child : directoryListing) {
			inputPath = Paths.get(child);
			input = FileChannel.open(inputPath);

	        List<Path> paths = phaseOne(input, coordToSort);
	        ...
	        paths = phaseTwo(paths, coordToSort);
	        ...
	        System.out.println("For file '"+dir+"', the number of Disk IO is "+numberOfDiskIO);
	    }
