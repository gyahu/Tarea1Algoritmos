...
public class Main {
    ...
    * String coordToSort : coordinate to sort the file by. (can be "x" or "y")
    * */
    public static List<Path> phaseTwo(List<Path> phaseOneOutput, String coordToSort) throws IOException{
    ...
    * String coordToSort : coordinate to sort the file by. (can be "x" or "y")
    * */
    public static List<Path> phaseTwoStep(List<Path> sortedRuns, String coordToSort) throws IOException{
